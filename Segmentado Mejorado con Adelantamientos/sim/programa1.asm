...
main:
  ...
  add $t1, $t3, $t2 # dependencia con la anterior # en r9 un 6 = 2 + 4 r9 = 5 = 2+3 
  nop
  nop
  nop
  add $t3, $t1, $t2 # en r11 un 8 = 6 + 2 r11 = 7 =5+2
  nop
  add $t2, $t4, $t3 #dependencia con la 2� anterior # en r10 un 16 = 8 + 8 r10 = 15 =7+8
  nop
  nop
  nop
  add $t3, $t1, $t2  # en r11 un 22 = 6 + 16 r11 = 20 =5+15
  nop
  nop
  ...
  nop
  nop
  add $s0, $t1, $t2  # en r16 un 20 = 5 + 15 r16 = 41
  add $s0, $s0, $s0  # Dependencia con la anterior  # en r16 un 40 = 20 + 20. r16 = 82 
  add $s1, $s0, $s0  # dependencia con la anterior  # en r16 un 80 = 40 + 40 r17 = 164
  nop
  nop
  nop
  nop
  # RIESGOS REGISTRO MEMORIA
  add $t3, $t1, $t2 # en r11 un 41 = 5 + 36 r11 = 41
